...
int f_2()
{
	...
	printf("\nСумма отрезков AC и BC: %.2lf", res);
...
int f_3()
{
	...
	printf("\nПроизведение отрезков AC и BC: %.2lf", res);
...
int f_4()
{
	...
	printf("\nПлощадь прямоугольника: %.2lf", res);
...
int f_5()
{
	...
	printf("\nПериметр треугольника: %.2lf", res1);
	printf("\nПлощадь треугольника: %.2lf", res2);
